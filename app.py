...
# -----------------------
# PDF GENERATOR (POPULATION)
# -----------------------
def generate_population_pdf(df, page):
    doc = SimpleDocTemplate("population_report.pdf")
    styles = getSampleStyleSheet()
    story = []
    ...
    with open("population_report.pdf", "rb") as f:
        return f.read()
